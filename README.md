...
- [Обзор проекта](#pz-iot-power-meter)
...
- [Меры безопасности](#⚠️меры-безопасности)
- [Особенности конфигурации](#-особенности-конфигурации)
- [Начало работы](#-начало-работы)
  - [1. Установите ESPHome](#1-установите-esphome)
  - [2. Скопируйте конфигурацию](#2-скопируйте-конфигурацию)
  - [3. Настройте секреты](#3-настройте-секреты)
  - [4. Настройте параметры (опционально)](#4-настройте-параметры-опционально)
  - [5. Скомпилируйте и загрузите](#5-скомпилируйте-и-загрузите)
  - [6. Откройте веб-интерфейс](#6-откройте-вебинтерфейс)
- [Интеграция с Home Assistant](#-интеграция-с-home-assistant)
- [Примеры интерфейса](#-примеры-интерфейса)
  - [Home Assistant](#home-assistent-example)
  - [Веб-интерфейс](#web-interface-example)
- [Возможные трудности](#-возможные-трудности-которые-могут-возникнуть)
  - [❌ Прошивка BK7231](#-прошивка-bk7231)
  - [❌ Ошибки компиляции](#-ошибки-компиляции)
- [Файлы прошивок](#-файлы-прошивок)
- [Лицензия](#-лицензия)
